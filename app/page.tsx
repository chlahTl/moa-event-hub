  ...
  return (
    <main className="landing-shell">
      <nav className="landing-nav">
        <Link href="/" className="brand-lockup" aria-label="모아 홈">
          <span className="brand-mark">ㅁ</span>
          <span>모아</span>
        </Link>
        <span className="institution-chip">NCHM 연계 행사 운영 시안</span>
        <Link href="/admin" className="text-link">관리자 화면 <span>↗</span></Link>
      </nav>
      ...
      <section className="hero-section">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <Link href="/admin" className="button button-primary">첫 행사 만들기 <span>→</span></Link>
      ...
      <footer className="landing-footer">
        ...
        <Link href="/admin">관리자 화면 시작하기 →</Link>
      </footer>
    </main>
  );
}
